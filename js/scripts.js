$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Alicia & Simon's Wedding",

            // Event start date
            start: new Date('May 24, 2025 12:00'),
            ...
            end: new Date('May 25, 2025 02:00'),

            // Event Address
            address: 'Schweriner Schloss, Schwerin, Germany',
...
// Google map
function initMap() {
    var location = {lat: 53.62494308306706, lng: 11.419680061443113};
...
function initBBSRMap() {
    var la_fiesta = {lat: 53.62410132125603, lng: 11.419871326546055};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
